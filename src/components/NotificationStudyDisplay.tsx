...
const NotificationStudyDisplay: React.FC = () => {
  ...
  if (isLoading) {
    return (
      <div className="h-64 md:h-80 bg-gray-800 bg-opacity-70 rounded-xl shadow-2xl overflow-hidden flex items-center justify-center text-white">
  ...
  if (error) {
    return (
      <div className="h-64 md:h-80 bg-red-800 bg-opacity-70 rounded-xl shadow-2xl overflow-hidden flex items-center justify-center text-white">
  ...
  return (
    <div className="h-64 md:h-80 bg-gray-800 bg-opacity-70 rounded-xl shadow-2xl overflow-hidden">
      <Swiper
        spaceBetween={30}
        centeredSlides={true}
        autoplay={{
